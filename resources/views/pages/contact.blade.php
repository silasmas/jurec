                    ...
                    <div class="contact-3-info page-section-ptb text-white">
                        <div class="clearfix">
                            ...
                            <p class="mb-50 text-white"> {{ $setting->site_description }}
                                <span class="tooltip-content-2" data-original-title="Mon-Fri 10am–7pm (GMT +1)"
                                    data-bs-toggle="tooltip" data-placement="top"> 24 heures!</span>
                            </p>

                            <ul class="addresss-info list-unstyled">
                                <li><i class="ti-map-alt"></i>
                                    <p>Addresse: 4746, Avenue de la Gombe, Immeuble Prefed, 2e niveau-local 201, en face de
                                        l'Ecole Belge de Kinshasa, Commune de la Gombe</p>
                                </li>
                            ...
                            <div class="social-icons social-border rounded color-hover mt-50">
                                <ul>
                                    ...
                                    <li {{ $settings['instagram'] == null ? 'hidden' : $settings['instagram'] }}>
                                        <a href="{{ $settings['instagram'] }}" target="blank"> <i
                                                class="fab fa-instagram"></i> </a>
                                    </li>

                                    <li {{ $settings['youtube'] == null ? 'hidden' : $settings['youtube'] }}>
                                        <a href="{{ $settings['youtube'] }}" target="blank"> <i class="fab fa-youtube"></i>
                                        </a>
                                    </li>
        ...
        <div class="container">
            <div class="row justify-content-center text-center mb-50">
                <div class="col-md-8">
                    <div class="section-title">
                        ...
                        <p>Avez-vous une question ou un retour à partager ? N'hésitez pas à nous écrire, nous sommes là pour
                            vous aider !</p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form id="formContact" role="form" method="post" action=""
                        onsubmit="event.preventDefault();add('#formContact', 'POST', '../addNewMessage')">
             ...
             <input type="text" placeholder="Sujet*" class="form-control" name="sujet">
                            ...
                            <div class="section-field submit-button">
                                ...
                                <button id="" name="" type="submit" value="Send" class="button"><span>
