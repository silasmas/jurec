<div class="modal fade" id="exampleModalMonitoring" tabindex="-1" aria-labelledby="exampleModalMonitoringLabel" aria-hidden="true">
    <div class="modal-dialog  modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>
                    JUREC réalise le suivi des activités de l’Administration publique, du secteur
...
<div class="modal fade" id="exampleModalFACILITATION" tabindex="-1" aria-labelledby="exampleModalFACILITATIONLabel" aria-hidden="true">
    <div class="modal-dialog  modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <div class="feature-step-2-title-left">
            ...
            <div class="modal-body">
                <p>
                    JUREC travaille pour accompagner les initiatives publiques et privées et autres
